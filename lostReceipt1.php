...
{        
        ...
        echo"<tr>";echo "<th>Budget Code(s)</th>"; echo"<td>";echo $row['budget_Code']; echo"</td>";
        echo"<tr>";echo "<th>Last 6 digits</th>"; echo"<td>";echo $row['Last_6_digits']; echo"</td>"; 
        echo"<tr>";echo "<th>Vendor Name</th>"; echo"<td>";echo $row['Vendor_Name']; echo"</td>"; 
        echo"<tr>";echo "<th>VDate of charge</th>"; echo"<td>";echo $row['Date_of_charge']; echo"</td>"; 
