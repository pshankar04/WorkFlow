...
{        
        echo"<tr>";echo "<th>Ticket ID</th>";  echo"<td>";echo $row['Ticket_ID']; echo"</td>";
        echo"<tr>";echo "<th>Creator</th>"; echo"<td>";echo $row['Creator']; echo"</td>";
        ...
        echo"<tr>";echo "<th>Approver</th>"; echo"<td>";echo $row['Approver']; echo"</td>"; 

        echo"<tr>";echo "<th>Budget code</th>"; echo"<td>";echo $row['budget_Code']; echo"</td>"; 
