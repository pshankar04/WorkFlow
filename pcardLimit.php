...
{        
        ...
        echo"<tr>";echo "<th>Desired range of increase</th>"; echo"<td>";echo $row['desired_Range_Increase']; echo"</td>";
        echo"<tr>";echo "<th>Justification for Increase</th>"; echo"<td>";echo $row['Justification']; echo"</td>"; 
