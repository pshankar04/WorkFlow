...
while($row = $result->fetch_assoc())
{
        ...
        $request = $row['RequestType'];
         ...
         if($request == 'limitIncrease'){
            ...
            echo"<td>";echo "<a href='http://qav2.cs.odu.edu/puneeth/WorkFlow/lostReceipt.php?id=$id'>"; echo $row['Request_ID']; echo"</a></td>"; 
        }elseif($request == 'carRental'){
        ...
        echo"<td>";echo "<a href='http://qav2.cs.odu.edu/puneeth/WorkFlow/accountCancellation.php?id=$id'>"; echo $row['Request_ID']; echo"</a></td>"; 
        }elseif($request == 'tempAccountMaintenance'){
