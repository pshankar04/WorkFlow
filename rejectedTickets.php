...
$sql = "SELECT * FROM Tickets_Status WHERE Creator='$var_value' AND (Supervisor_Approval='1' AND Procurement_Approval='0') OR (Supervisor_Approval='0' AND Procurement_Approval='0')";
